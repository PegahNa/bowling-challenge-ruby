...
describe Frame do
    ...
    describe "#is_spare?" do
      ...
      it "should return false if the first two balls are not a spare" do
        frame.roll(9)
        frame.roll(2)
    ...
    describe "#bonus" do
      ...
      it "should return 10 - the first ball for a spare" do
        frame.roll(9)
        frame.roll(1)
        expect(frame.bonus).to eq(10 - 9)
      end
    ...
    describe "#total_score" do
      ...
      it "should return the score + the bonus" do
        frame.roll(10)
        frame.roll(9)
        expect(frame.total_score).to eq(29)
      end
